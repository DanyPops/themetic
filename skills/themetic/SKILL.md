...
not your judgment. This split exists because this project once shipped a
saturated red-on-green color combination by hand, and a screenshot caught it
only after the fact. Contrast math alone hadn't caught it, and free-form
color choices don't self-audit. Do not shortcut the tool by describing
colors in prose instead of calling it.
...
fact beats a vague adjective. Armenia's flag is literally red/blue/
...
accuracy comparable to image-based methods; see RESEARCH.md in this package),
...
and teal highlights" is one warm hue family (browns are what the neutral ramp looks
